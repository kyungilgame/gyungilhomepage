        ...
        <SlideWrapper>
          <SlideColumnWrapper>
            <ItemWrapper>
              ...
              ></div>
              <TextBox>
                게임은 선사시대부터 있었던 사피엔스 고유의 특성입니다. 게임
                기획은 뇌 과학 이론까지 흘러가기도 합니다. 그래서, 게임 기획은
                너무나 멋진 일이고, 그렇기에 실무 위주 스파르타 교육을 받아야만
                합니다. KGA는 전문 선수를 육성하는 시스템으로, 여러분이 기획자가
                될 때까지 육성합니다. 기획자로 입문하고 싶은 분은 준비하실 건
                별거 없습니다. 마음만 단단히 먹고 오시길 바랍니다. 그럼 기획자
                될 수 있습니다.
              </TextBox>
            </ItemWrapper>
            <ItemWrapper>
              ...
              <TextBox>
                ...
                실력이 향상되는 편법이라는 것이 없다. 좋은 개발자의 조건은
                최대한 코딩 하지 않고 결과를 낼 수 있는 능력, 시간을 지키는
                것이라고 생각한다. 지식과 경험을 바탕으로 학생들을 지도하고
                멘토링을 하면서 수강생들이 신입 개발자로서의 새로운 커리어를
                시작할 수 있도록 함께 고민하고 노력한다.
              </TextBox>
            </ItemWrapper>
            <ItemWrapper>
              <div
              ...
              ></div>
              <TextBox>
                함께 일할 ‘후배 프로그래머’를 가르친다는 마음가짐으로 교육을
                하고 있다. 지식과 훈련의 균형을 중요하게 생각하고,
                프로그래밍뿐만 아니라 게임 개발에 필요한 소양을 키우도록
                지도한다. 취업을 넘어서 모두가 원하는 게임 프로그래머를 키우는
                게 목표다.
              </TextBox>
            </ItemWrapper>
            ...
            <ItemWrapper>
              ...
              <TextBox>
                ...
                생각, 글쓰기, 그림 그리기, 건축… 내가 창조한 공간을 공유하고
                싶을 때, 우리는 마찬가지로 다양한 방법을 사용한다. 대화,
                보여주기, 시연, 출판…. 우리는 그 어느 때보다 손쉽게 창조하고
                공유할 수 있는 시대에 살고 있다. 물론, 그 일은 생각보다 지루하고
                잠들어 있는 논리력을 필요로 하는 작업일 수 있다. 그렇기에 노력할
                가치가 있고 재미와 보람을 느낀다.
              </TextBox>
            </ItemWrapper>
            <ItemWrapper>
              ...
              <TextBox>
                ...
                이것들을 어떻게 전달할지 고민하는 것이 나의 새로운 목표가
                되었다.
              </TextBox>
            </ItemWrapper>
            ...
            <ItemWrapper>
              ...
              ></div>
              <TextBox>
                자신의 생각을 풀어나가는 것, 그것이 프로그램이라고 나는 단언할
                수 있다. 나의 프로그래머로서의 길은 새로운 문제를 어떻게
                풀어나갈지의 벽을 마주치는 것의 반복이었다. 이 벽을 부수는 것은
                수많은 공부를 통한 체력 강화, 그리고 아이디어의 약점을 파악하는
                것이다. 학생들에게 말한다. ‘매일 공부하여 어떤 벽을 만나더라도
                부술 수 있는 체력과 아이디어를 가지도록 노력해야 한다.’
              </TextBox>
            </ItemWrapper>
            <ItemWrapper>
              <div
              ...
              ></div>
              <TextBox>
                학생이 포기하지 않으면 포기하지 않는다. 개발자로서 삽질과
                향상심의 마음가짐을 가장 중요하게 생각하고, 기본에 대해서는 같은
                설명이라도 납득이 될 때까지 지도해줄 수 있는 끈기있는
                교육자이다. 응용에 대해서는 스스로 깨우칠 수 있도록 방향성을
                제시해주며, 기술교육대학 출신으로서 체계화된 교육방식과
                실무지식으로 갖추어진 현업과 가까운 지도를 진행한다.
              </TextBox>
            </ItemWrapper>
