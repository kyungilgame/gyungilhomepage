...
import MainReviewSlide from "../Component_M/MainReviewSlide";
...
export default function MainReviewCarousel({ menuState, SetMenuState }) {
  ...
  useEffect(() => {
    ...
    slideRef.current.style.transform = `translateX(-${currentSlide * 10}%`; // 백틱을 사용하여 슬라이드로 이동하는 애니메이션을 만듭니다.
  }, [currentSlide]);
  ...
  return (
    ...
    >
      ...
      >
        <Link
          to="/courseReview"
          //to="https://forms.gle/tf29emczqnuLrCmZ9"
        >
          <text
            style={{
              color: "#f6f6f6",
