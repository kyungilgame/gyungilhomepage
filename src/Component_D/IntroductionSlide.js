        ...
        <ItemWrapper>
          <ItemWrapper>
            ...
            <EachItemWrapper>
              ...
              <EachItemComment>
                게임과 컴퓨터를 좋아하여 관련 학과를 전공 중, 프로그래밍의
                재미를 알게 되었다. 월드 오브 워크래프트라는 게임에 빠지게 된
                후, 대학을 졸업하고 진로를 걱정할 때 게임을 직접 만들어 보고
                싶어 게임 프로그래밍의 길을 가게 되었다. 학생들에게 게임
                프로그래밍의 재미와 스스로 개발을 할 수 있는 역량을 발휘할 수
                있게 하는게 목표다.
              </EachItemComment>
            </EachItemWrapper>
            <EachItemWrapper>
