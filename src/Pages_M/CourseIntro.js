  ...
  return (
    <>
      ...
      <ContentsBoxTwoContainer>
        ...
        <TextSizeTwo>
          교육 이후에는 최대 6개월 동안 취업에 대한 지원을 받을 수 있습니다.
        </TextSizeTwo>
        ...
        <TextSizeTwo>
          실무적인 기술들을 익히며 업계 최고 수준의 주니어 개발자로 성장하게
          됩니다.
        </TextSizeTwo>
        <TextSizeTwo>
        ...
        <TextSizeTwo marginTop={"2vw"}>
          수강생들은 매일 오전 주어진 문제를 해결하며 기초를 다지고,
        </TextSizeTwo>
        <TextSizeTwo>
          오후 시간에는 실습과 과제, 프로젝트 기반 훈련을 진행하는데 대부분의
          시간을 투자합니다.
        </TextSizeTwo>
        <TextSizeTwo>
          앞으로의 학습 방향성을 체크하며, 과제 진행 중 문제가 있을 땐
        </TextSizeTwo>
        <TextSizeTwo>상주하는 멘토와 함께 문제를 해결합니다.</TextSizeTwo>
        <TextSizeTwo>
      ...
      <ContentsBoxThreeContainer>
        ...
        <CourseWrapper image={backImage_blockchain}>
          ...
          <ApplyButton as={"a"} href={"https://kgabeginner.oopy.io/"}>
            바로가기
          </ApplyButton>
        </CourseWrapper>
